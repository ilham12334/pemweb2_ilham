    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                ...
                $ns1 = new Mahasiswa("012011", "Ilham Maulana Hakim", "TI", 2012, 3.8, "Cum Laude");
                $ns2 = new Mahasiswa("012012", "Sadewa Manggadana", "TI", 2012, 3.9, "Cum Laude");
                $ns3 = new Mahasiswa("011011", "Bia Nabila", "SI", 2010, 3.46, "Memuaskan");
                $ns4 = new Mahasiswa("011012", "Putri Aulia", "SI", 2010, 3.2, "Memuaskan");
                $ns5 = new Mahasiswa("013011", "Andra Wiguna", "BD", 2014, 2.9, " Kurang Memuaskan");
                $ns6 = new Mahasiswa("013012", "Kenzie Maria", "BD", 2014, 2.5, " Kurang Memuaskan");
